...
public class KeywordsBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements KeywordsVisitor<T> {
	 ...
	 */
	@Override public T visitStart(KeywordsParser.StartContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitText(KeywordsParser.TextContext ctx) { return visitChildren(ctx); }
}